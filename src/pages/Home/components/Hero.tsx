    ...
    >
      ...
      <div className="mx-auto w-full max-w-5xl">
        ...
        <div className="mt-12 sm:mt-16">
          ...
          <h1 className="mt-5 text-5xl font-extrabold leading-[1.02] tracking-tight text-white sm:text-7xl lg:text-8xl">
            {PROFILE.name}
          </h1>
        </div>

        {/* Location + summary */}
        <div className="mt-10 grid gap-8 sm:mt-12 sm:grid-cols-[minmax(0,1fr)_minmax(0,2.5fr)] sm:gap-12">
          ...
          <p className="text-lg font-light leading-relaxed text-zinc-300 sm:text-xl">
            {PROFILE.summary}
          </p>
        </div>
